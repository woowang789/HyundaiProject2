            ...
            <div class="loginArea new login">
                <div class="box_type_1">
                        ...
                        <table class="tbl_wtype1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" id="pw" name="passwd" style="width:150px" placeholder="이름을 입력해주세요.">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" id="pwc" style="width:310px" placeholder="법정생년월일 6자리를 입력해주세요.">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" style="width:310px" id="name" placeholder="휴대폰 번호를 입력해 주세요(ex: 010-0000-0000)">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="btnwrap">
                        ...
                        <input type="button" value="아이디 찾기" class="btn gray mr0" id="joinBtn">
                    </div>
                </div>
            </div>
        </div>
