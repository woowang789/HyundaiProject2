								...
								<li class="flag">
									<div class="prd_info ">
										<a href="/product-detail?pid=${item.id }"
											...
											<img src="${item.thumb }" alt="클리오 킬커버 메쉬글로우 쿠션"
											onerror="common.errorImg(this);">
										</a>
										<div class="prd_name">
											<a href="javascript:;" name="Home_Recommand"
												...
												class="tx_brand">${item.brandName }</span>
												<p class="tx_name">${item.name }</p>
											</a>
										</div>
				...
				<div class="inner_unit">
					<div>
						<ul class="comm3sTabs sixSet" id="tabList">
							<li
								class="<c:if test="${brand[0].brandName eq '록시땅' }">on</c:if>"
								data-ref-brndno="A003496"><a
								href="home?brandName=록시땅#tabList" data-attr="">록시땅</a></li>
							<li
								class="<c:if test="${brand[0].brandName eq '베네피트' }">on</c:if>"
								data-ref-brndno="A003368"><a
								href="home?brandName=베네피트#tabList" data-attr="">베네피트 </a></li>
							<li
								class="<c:if test="${brand[0].brandName eq '보다나' }">on</c:if>"
								data-ref-brndno="A001316"><a
								href="home?brandName=보다나#tabList" data-attr="">보다나 </a></li>
							<li
								class="<c:if test="${brand[0].brandName eq '바비브라운' }">on</c:if>"
								data-ref-brndno="A005671"><a
								href="home?brandName=바비브라운#tabList" data-attr="">바비브라운 </a></li>
							<li class="<c:if test="${brand[0].brandName eq '맥' }">on</c:if>"
								data-ref-brndno="A002992"><a
								href="home?brandName=맥#tabList" data-attr="">맥 </a></li>
							<li
								class="<c:if test="${brand[0].brandName eq '톤28' }">on</c:if>"
								data-ref-brndno="A001619"><a
								href="home?brandName=톤28#tabList" data-attr="">톤28 </a></li>
						</ul>
						<div class="main_brand_tab main_brand brndList show"
							...
							<div class="brand_more">
								<a href="/search?keyword=${brand[0].brandName}"> <span>
										${brand[0].brandName}</span> 브랜드 상품 전체보기
								</a>
							</div>
						</div>
					</div>
