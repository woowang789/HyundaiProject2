...
<div id="Container">
	...
	<div class="sale-area">
		...
		<div class="common-menu">
			<ul>
				<li class="on">
					<button type="button" data-ref-dispcatno=""
						data-attr="세일^세일카테고리_핫인기세일^전체">전체</button>
				</li>
				<!-- 그 외 -->
				<li>
					<button type="button" data-ref-dispcatno="10000010001"
						data-attr="세일^세일카테고리_핫인기세일^스킨케어">스킨케어</button>
				</li>
				<!-- 그 외 -->
		...
		<div class="TabsConts on">
				...
				<div class="count_sort tx_num">
					...
					<ul>
						<c:if test="${pageMaker.cri.amount eq 24}">
							<li class="on"><a href="javascript:;" title="24개씩 보기"
								data-value="24">24</a></li>
							<li><a href="javascript:;" title="36개씩 보기" data-value="36">36</a>
							</li>
							<li><a href="javascript:;" title="48개씩 보기" data-value="48">48</a>
							</li>
						</c:if>
						<c:if test="${pageMaker.cri.amount eq 36}">
							<li><a href="javascript:;" title="24개씩 보기" data-value="24">24</a>
							</li>
							<li class="on"><a href="javascript:;" title="36개씩 보기"
								data-value="36">36</a></li>
							<li><a href="javascript:;" title="48개씩 보기" data-value="48">48</a>
							</li>
						</c:if>
						<c:if test="${pageMaker.cri.amount eq 48}">
							...
							<li class="on"><a href="javascript:;" title="48개씩 보기"
								data-value="48">48</a></li>
						</c:if>
					</ul>
				</div>
				<div class="type_sort">
			...
			<ul class="cate_prd_list gtm_sale_list">
				<c:forEach var="item" items="${sale_list}">
					<li class="flag">
						<div class="prd_info ">
							<a href="/product-detail?id=${item.id }" name="Sale_Pop"
								class="prd_thumb goodsList"> <span class="newOyflag today">
									<em>오특</em>
							...
							</span> <img src="${item.thumb }" alt="${item.name}"
								onerror="common.errorImg(this);">
							</a>
							<div class="prd_name">
								<a href="/product-detail?id=${item.id}"> <span
							...
							<p class="prd_price">
								...
								</span> <span class="tx_cur"> <span class="tx_num"> <fmt:formatNumber
