						...
						<div class="graph_area">
							<ul class="graph_list">
								...
								<div class="cate_align_box prodLine review_N2" id="searchType">
									<div class="align_sort">
										...
										<ul id="gdasSort">
											<li class="is-layer on"><a href="javascript:;"
												...
												<div class="comment-layer">리뷰의 글자수, '도움이 돼요'수 , 등록된
													사진, 최신 작성일등을 점수화하여 올리브영이 추천하는 리뷰를 정렬합니다.</div></li>
									...
									<input type="hidden" name="showFilter" id="showFilter"
										value="Y">
												...
												<div class="review_thum type1">
													<ul class="inner clrfix">
														<li><a href="#" data-attr="상품상세^포토리뷰^포토 클릭^1"><span><img
																	...
																	data-value="16677214_1" class="thum" alt=""
									...
									<div id="Contents">
										...
										<div class="prd_detail_box renew">
											<div class="left_area">
												<div class="prd_img">
													<span class="thumb_flag best">베스트</span> <img id="mainImg"
														src="<c:out value="${product_detail.pimg}" />"
														alt="상품명 이미지" /> <input type="hidden" id="mainImgSize"
														value="550" />
													<!-- 20200526 상품개선 : 추가 / 발색비교 옵션 선택 시 옵션명 변경 및 관련 썸네일로 변경 -->
													<div class="prd-option-name">
														<!-- 노출 시 is-active class 추가 -->
											...
											<div class="right_area">
												<div class="prd_info">
													...
													<div class="price">
														<span class="price-1"> <strike><fmt:formatNumber
																	value="${product_detail.optionList[0].originPrice}" /></strike>
															<span>원</span>
														</span> <span class="price-2"> <strong><fmt:formatNumber
																	value="${product_detail.optionList[0].marketPrice}" />
														</strong> <span>원</span>
														</span>
													</div>
													<c:if
													...
													<div class="prd_more_info">
														<div class="row">
															<ul class="bl_list">
																<li><span>일반배송</span>
																	<div>
																		2,500원 ( 20,000 원 이상 무료배송 ) <br /> <em>올리브영 배송 </em>
																		<em>평균 9일 이내 배송</em>
																	</div></li>
															</ul>
														</div>
													...
													<div class="prd_option_box optionType1 type2"
														...
														<ul class="sel_option_list new" id="option_list">
															<c:forEach var="option"
																items="${product_detail.optionList}">
																<li class="">
																	<!-- 혜택 아이콘 li 분기 끝 --> <!--//옵션 선택시 오늘드림 옵션 상품을 제어하기 위해서 오늘드림 여부 추가//-->
																	<a style="cursor: pointer"> <c:if
																			test="${not empty option.othumb}">
																			<span class="color"> <img
																				src="<c:out value='${option.othumb}'/>" alt=" ">
																			</span>
																		</c:if>
																		<div class="set">
																			<span class="option_value"> <c:out
																					value="${option.oname}" /> <span
													...
													<div class="prd_total_price">
														<span class="tx_tit">상품금액 합계</span> <input type="hidden"
															id="totalCnt" value="0" name="totalCnt" /> <input
															type="hidden" id="totalPrc" value="0" name="totalPrc" />
														<span class="tx_cont"> <span class="tx_num"
															id="totalPrcTxt">0</span> 원
														</span>
													</div>
													<!-- 20191213 s -->
													<!-- today_dvs s -->
													<div class="today_dv">
														...
														<div class="today_dvArea">
															<div class="today_dvArea_inner">
																<a href="" class="btn_noDv" style="display: none">+
																	배송지 추가</a> <a href="#" class="btn_todayDV">
																	<dl></dl>
																</a>
																<div class="todayDV_list">
																	<ul></ul>
														...
														<!-- //today_dvArea e -->
														<div class="today_dvChk" id="pikcupOnlyYn"
															style="display: none">
															<input type="checkbox" id="pickupDirectYn"
																name="pickupDirectYn" value="Y"
																data-attr="상품상세^매장픽업여부^매장픽업신청" /> <label
																for="pickupDirectYn">매장에서 픽업 하시겠어요?</label>
															<dl>
																<dd>
																	<a
										...
										<ul class="prd_detail_tab" id="tabList">
											<li class="on" data-tab="productInfo"><a href="#tabList"
												class="goods_detailinfo"
												data-attr="상품상세^상품상세_SortingTab^상품설명">상품설명</a></li>
											<li data-tab="buyInfo"><a href="#tabList"
												class="goods_buyinfo" data-attr="상품상세^상품상세_SortingTab^구매정보">구매정보</a>
											</li>
											<li data-tab="reviewInfo"><a href="#tabList"
												class="goods_reputation" data-attr="상품상세^상품상세_SortingTab^리뷰">
													리뷰 <span>(1,888)</span>
											</a></li>
											<li id="qnaInfo"></li>
										</ul>
										<div class="tabConts prd_detail_cont show" id="productInfo"
											...
											<div class="detail_area">
												...
												<div class="contEditor">
													<c:set var="pctnts"
														value="${fn:split(product_detail.pctnt,',')}" />
													<c:forEach var="pctnt" items="${pctnts}">
														<img alt="" src="<c:out value= " ${pctnt}"/>" />
													</c:forEach>
												</div>
											...
											<p class="tit_cate_best mgT40 dispCatBest"
												style="display: none">스킨케어 카테고리 베스트 상품</p>
											<ul class="cate_prd_list dispCatBest" id="recommGoodsList"
												style="display: none"></ul>
											<div class="curation_area_a029_lead"></div>
											<div id="recobell_area_a029"
												class="cura_pord curation_area_029 btm"
												style="display: none">
												<h4 class="tit_h4">함께 보면 좋은 상품이에요</h4>
												<div class="loading_box">
													<span class="icon"> <img
										...
										<div class="tabConts prd_detail_cont" id="buyInfo"
											data-tab="buyInfo">
											<h3 class="detail_tit mgT40">배송안내</h3>
											<dl class="detail_info_list" id="dlexAjaxInfo">
												<dt>배송비/배송가능일</dt>
												<dd>
													<div>
														...
														<p>배송가능일이란 본 상품을 주문하신 고객님들께 상품 배송이 가능한 기간을 의미합니다. 단,
															연휴 및 공휴일은 기간 계산시 제외하며 현금 주문일 경우 입금일 기준 입니다.</p>
														<p>예약 상품의 경우 예약된 날짜에 출고되며, 상품의 입고가 빠르게 진행된 경우 예약일 보다
															일찍 배송될 수 있습니다.</p>
													</div>
													<br />
													<div>
														...
														<p>
															오늘드림 배송 상품의 총 결제금액&nbsp; <span>30,000</span> 원 이상일
															경우&nbsp; <span>무료배송</span> &nbsp;됩니다.
														</p>
														<p>오늘드림 배송비는 도서, 산간지역에 관련없이 배송비가 동일합니다.</p>
														<div class="crlfix">
															<p style="float: left">
															...
															<div style="margin-left: 87px">
																<p>
																	<strong>빠름/미드나잇 </strong>당일 20시까지 주문 시 당일 도착, 이후 주문 건
																	익일 도착
																</p>
																<p>
																	<strong>3!4! </strong>당일13시까지 주문 시 당일 도착, 이후 주문 건 익일 도착
										...
										<div class="tabConts prd_detail_cont" id="reviewInfo"
											...
											<div class="review_wrap renew review-reward-notice">
												...
												<input type="hidden" name="gdasItemNo" id="gdasItemNo"
													value="all_search"> <input type="hidden"
													name="gdasLgcGoodsNo" id="gdasLgcGoodsNo"
													value="all_search"> <input type="hidden"
													name="selectedNum" id="selectedNum" value="">
												<!-- //## 리뷰 고도화 1차 ## 추가 -->
												<input type="hidden" name="itemCnt" id="itemCnt" value="1">
												<input type="hidden" id="dispImgUrl"
													value="https://image.oliveyoung.co.kr/uploads/images/display/">
												<input type="hidden" id="bnrImgUrl"
													value="900000100050003/131/1936525083404364428.jpg">
												...
												<div class="product_rating_area review-write-delete">
													<div class="inner clrfix">
														<div class="star_area">
															...
															<ul class="star_list">
																<li><span class="rating"></span> <img
																	src="https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png">
																</li>
																<li><span class="rating"></span> <img
																	src="https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png">
																</li>
																...
																<li><span class="rating" style="width: 70%;"></span>
																	<img
																	src="https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png">
																</li>
															</ul>
												...
												<div class="cate_align_box prodLine review_N2"
													id="searchType">
													<div class="align_sort">
														<!-- 리뷰 고도화 1차 : 항목 변경 -->
														<ul id="gdasSort">
															<li class="is-layer on"><a href="javascript:;"
																...
																<div class="comment-layer">리뷰의 글자수, '도움이 돼요'수 ,
																	등록된 사진, 최신 작성일등을 점수화하여 올리브영이 추천하는 리뷰를 정렬합니다.</div></li>
															<li><a href="javascript:;" data-value="01"
																data-attr="상품상세^리뷰정렬^도움순">도움순</a></li>
															<li><a href="javascript:;" data-value="02"
																data-attr="상품상세^리뷰정렬^최신순">최신순</a></li>
													...
													<ul class="inner_list" id="gdasList">
														<li>
															...
															<div class="review_cont">
																<div class="score_area">
																	<span class="review_point"> <span class="point"
																		style="width: 100%">5점만점에 5점</span>
																	</span> <span class="date">2022.12.27</span>
																</div>
																<div class="txt_inner">
																	솔직히&nbsp;관리&nbsp;자체가&nbsp;귀찮아서&nbsp;꾸준히&nbsp;쓰지는&nbsp;않았어요ㅠㅋㅋㅋ&nbsp;아이세럼스틱&nbsp;정말&nbsp;쓰기&nbsp;편하게&nbsp;생겨서&nbsp;좋거든요&nbsp;한번만&nbsp;딱&nbsp;짜서&nbsp;눈가에&nbsp;발라주면&nbsp;되고,&nbsp;롤러가&nbsp;시원해서&nbsp;느낌도&nbsp;좋고&nbsp;눈&nbsp;주위엔&nbsp;확실히&nbsp;영양이&nbsp;부족한지&nbsp;주름지기&nbsp;쉬우니까&nbsp;집중관리해주면&nbsp;촉촉해지는것도&nbsp;보이고&nbsp;좋은데&nbsp;꾸준히&nbsp;쓰기는&nbsp;쉽지않네요&nbsp;ㅋㅋ&nbsp;지금도&nbsp;리뷰&nbsp;쓴다고&nbsp;생각난김에&nbsp;발라줬어요&nbsp;<br>눈가에&nbsp;쓰면&nbsp;시릴수도&nbsp;있는데&nbsp;그렇지도&nbsp;않고&nbsp;피부가&nbsp;간지럽거나&nbsp;한것도&nbsp;없어요&nbsp;자극이&nbsp;없고&nbsp;사용감이&nbsp;좋습니다&nbsp;<br>
																	<br>아이세럼&nbsp;필요하신분들에게&nbsp;강추해요&nbsp;아주&nbsp;편해요👍🏻
																...
																<div class="review_thum type1">
																	<ul class="inner clrfix">
																		<li><a href="#" data-attr="상품상세^포토리뷰^포토 클릭^1">
																				<span> <img
																					src="https://image.oliveyoung.co.kr/uploads/images/gdasEditor/2022/12/27/1672145255473.png?RS=165x165&amp;CS=165x165"
																					data-value="16677214_1" class="thum" alt="">
																			</span>
