  ...
  <div id="Contents">
    ...
    <div class="prd_detail_box renew">
      <div class="left_area">
        <div class="prd_img">
          ...
          <img id="mainImg" src="https://image.oliveyoung.co.kr/uploads/images/goods/550/10/0000/0014/A00000014453508ko.jpg?l=ko" alt="상품명 이미지" onerror="common.errorImg(this);" />
          ...
          <div class="prd_more_info">
            <div class="row">
              <ul class="bl_list">
                ...
                <li class="liQuickAI" style="display: none">
                  <span class="tx_tit">
                    오늘드림 빠름 배송 AI 예측
                    <!-- 202005 상품개선 : 자세히 보기 위치 변경 -->
                    <a href="javascript:goods.detail.todayDelivery.openQuickDeliAI();" class="ico_infoMore">자세히 보기</a>
                  </span>
                  <p class="tx_addre">
                    <span>┖ </span>
                    <span class="quickUsrAddr">서울특별시 도봉구 도봉로112길</span>
                    기준
                    <!-- 202005 상품개선 : tx_cont 위치 변경 -->
                    <span class="tx_cont">
                      <span class="span_dlvTitlNm">1시간 내</span>
                      <span class="span_maxDeliPer">63%</span>
                    </span>
                  </p>
                </li>
              </ul>
    ...
    <div class="tabConts prd_detail_cont show" id="productInfo" dat-tab="productInfo">
      <div class="detail_area">
        ...
        <!-- 전시카테고리 더모 카테고리 노출 -->
        <!-- 전시카테고리 그외 카테고리 노출 -->
        <a href="https://www.oliveyoung.co.kr/store/planshop/getPlanShopDetail.do?dispCatNo=500000102360106&amp;trackingCd=Banner" data-attr="상품상세^MD공지배너^100000100010008,100000100010009,100000100010010_클릭"
          data-trk="/Cat100000100010008_Small" onclick="javascript:common.wlog('mdBanner');"
        >
          <img src="https://image.oliveyoung.co.kr/uploads/images/display/9000003/19/8993007353449249222.jpg" alt="100000100010008,100000100010009,100000100010010" />
        </a>
        ...
        <div class="contEditor">
          ...
          <img alt="" src="https://image.oliveyoung.co.kr/uploads/images/editor/QuickUpload/C15399/image/20221117143807/qc15_20221117143807.jpg" />
        </div>
