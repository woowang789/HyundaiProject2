  ...
  <div id="Contents">
    ...
    <div class="prd_detail_box renew">
      ...
      <div class="right_area">
        <div class="prd_info">
          <p class="prd_brand">
            <a href="#" id="moveBrandShop" class="pd_arrow_link">
              <c:out value="${product_detail.bname}" />
            </a>
          </p>
          <p class="prd_name">
            <c:out value="${product_detail.pname}" />
          ...
          <div class="price">
            <span class="price-1">
              <strike><fmt:formatNumber value="${product_detail.optionList[0].originPrice}" /></strike>
              <span>원</span>
            </span>
            <span class="price-2">
              <strong><fmt:formatNumber value="${product_detail.optionList[0].marketPrice}" /> </strong>
              <span>원</span>
            </span>
          </div>
          <c:if test="${product_detail.optionList[0].originPrice ne product_detail.optionList[0].marketPrice}">
            <p class="prd_flag">
              <span class="icon_flag sale">세일</span>
            </p>
          </c:if>
            ...
            <div class="row">
              <ul class="bl_list">
                <li>
                  <span>일반배송</span>
                  <div>
                    2,500원 ( 20,000 원 이상 무료배송 ) <br /> <em>올리브영 배송 </em> <em>평균 9일 이내 배송</em>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="prd_option_box optionType1 type2" id="buy_option_box">
            <a href="javascript:;" class="sel_option" id="buyOpt"> 상품을 선택해주세요 </a>
            <ul class="sel_option_list new" id="option_list">
              <c:forEach var="option" items="${product_detail.optionList}">
                <li class="">
                  <!-- 혜택 아이콘 li 분기 끝 -->
                  <!--//옵션 선택시 오늘드림 옵션 상품을 제어하기 위해서 오늘드림 여부 추가//-->
                  <a style="cursor: pointer"
                    onclick="javascript:goods.detail.cart.selectItem('002','아토덤립스틱 1+1 기획','A000000175267','', '','','N', '', '910', 'N', '10500', '1', '1', '999', 'N', '', '', '', '', '', '8809371193852','Y', '', '');"
                  >
                    <c:if test="${not empty option.othumb}">
                      <span class="color">
                        <img src="<c:out value='${option.othumb}'/>" alt=" ">
                      </span>
                    </c:if>
                    <div class="set">
                      <span class="option_value">
                        <c:out value="${option.oname}" />
                        <span class="option_price">
                          <span class="tx_num">
                            <fmt:formatNumber value="${option.marketPrice}" />
                            원
                          </span>
                        </span>
                      </span>
          ...
          <div class="prd_total_price">
            ...
            <span class="tx_cont">
              <span class="tx_num" id="totalPrcTxt">0</span>
              원
            </span>
          </div>
          <!-- 20191213 s -->
          ...
          <div class="today_dv">
            ...
            <!-- //today_dvArea e -->
            <div class="today_dvChk" id="pikcupOnlyYn" style="display: none">
              <input type="checkbox" id="pickupDirectYn" name="pickupDirectYn" value="Y" data-attr="상품상세^매장픽업여부^매장픽업신청" />
              <label for="pickupDirectYn">매장에서 픽업 하시겠어요?</label>
              <dl>
                <dd>
                  <a href="javascript:goods.detail.todayDelivery.openQuickPopMidle('pickup');" class="ico_info_view">매장픽업 안내 레이어열기</a>
                </dd>
              </dl>
          ...
          <div class="prd_btn_area new-style type1">
            ...
            <button class="goods_buy btnReStock" style="display: none" onclick="javascript:;" data-attr="상품상세^재입고알림신청^브로앤팁스 네버오일리 올인원 120ML 기획(+바디워시100ML)_클릭" data-trk="/Cat100000100010008_Small">재입고 알림신청</button>
            <button class="btnZzim goods_wish" data-ref-goodsno="A000000144535" data-attr="상품상세^상품좋아요^브로앤팁스 네버오일리 올인원 120ML 기획(+바디워시100ML)_0">찜하기전</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- 큐레이션 2차 E -->
    <ul class="prd_detail_tab" id="tabList">
      <li class="on" data-tab="productInfo">
        <a href="#tabList" class="goods_detailinfo" data-attr="상품상세^상품상세_SortingTab^상품설명">상품설명</a>
      </li>
      <li data-tab="buyInfo">
        <a href="#tabList" class="goods_buyinfo" data-attr="상품상세^상품상세_SortingTab^구매정보">구매정보</a>
      </li>
      <li data-tab="reviewInfo">
        <a href="#tabList" class="goods_reputation" data-attr="상품상세^상품상세_SortingTab^리뷰">
          리뷰
          <span>(1,888)</span>
        </a>
      </li>
    ...
    <div class="tabConts prd_detail_cont show" id="productInfo" dat-tab="productInfo">
      <div class="detail_area">
        <!-- 협력사, 온라인브랜드, 상품 카테고리 노출 -->
        <div class="contEditor">
          <script>
      ...
      <ul class="cate_prd_list dispCatBest" id="recommGoodsList" style="display: none"></ul>
      <div class="curation_area_a029_lead"></div>
      ...
      <dl class="detail_info_list" id="dlexAjaxInfo">
        ...
        <dd>
          ...
          <div>
            ...
            <p>
              <strong>배송비 : </strong><strong>빠름</strong>&nbsp;
              <span>5,000원</span>
              , <strong>3!4!/미드나잇</strong>&nbsp;
              <span>2,500원</span>
            </p>
            <p>
              오늘드림 배송 상품의 총 결제금액&nbsp;
    ...
    <div class="tabConts prd_detail_cont" id="reviewInfo" data-tab="reviewInfo">
      <div class="review_wrap renew review-reward-notice">
        <!-- ## 리뷰 고도화 1차 : 영역 부모 div 추가 ## -->
        <!-- 옵션start -->
        <input type="hidden" name="gdasItemNo" id="gdasItemNo" value="all_search">
        <input type="hidden" name="gdasLgcGoodsNo" id="gdasLgcGoodsNo" value="all_search">
        <input type="hidden" name="selectedNum" id="selectedNum" value="">
        <!-- //## 리뷰 고도화 1차 ## 추가 -->
        <input type="hidden" name="itemCnt" id="itemCnt" value="1">
        <input type="hidden" id="dispImgUrl" value="https://image.oliveyoung.co.kr/uploads/images/display/">
        <input type="hidden" id="bnrImgUrl" value="900000100050003/131/1936525083404364428.jpg">
        <input type="hidden" id="bnrImgTxtCont" value="올영체험단 PC 배너">
        <div class="product_rating_area review-write-delete">
          <div class="inner clrfix">
            <div class="star_area">
              <p class="total">
              ...
              <ul class="star_list">
                <li>
                  ...
                  <img src="https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png">
                </li>
                <li>
                  <span class="rating"></span>
                  <img src="https://static.oliveyoung.co.kr/pc-static-root/image//product/bg_rating_star.png">
        ...
        <div class="cate_align_box prodLine review_N2" id="searchType">
          <div class="align_sort">
            <!-- 리뷰 고도화 1차 : 항목 변경 -->
            <ul id="gdasSort">
              <li class="is-layer on">
                <a href="javascript:;" data-value="05" data-attr="상품상세^리뷰정렬^유용한순">유용한순</a>
                <button type="button" class="btn-open-layer">
                  <span>자세히 보기</span>
                </button>
                <div class="comment-layer">리뷰의 글자수, '도움이 돼요'수 , 등록된 사진, 최신 작성일등을 점수화하여 올리브영이 추천하는 리뷰를 정렬합니다.</div>
              </li>
              <li>
                <a href="javascript:;" data-value="01" data-attr="상품상세^리뷰정렬^도움순">도움순</a>
              </li>
              <li>
                <a href="javascript:;" data-value="02" data-attr="상품상세^리뷰정렬^최신순">최신순</a>
              </li>
            </ul>
            <!-- // 리뷰 고도화 1차 : 항목 변경 -->
          </div>
            ...
            <li>
              <div class="info">
                <div class="user clrfix">
                  ...
                  <!--## 리뷰 고도화 1차 ## : top, id 위치 변경 및 마크업 변경 -->
                  <p class="info_user">
                    <a href="javascript:;" onclick="goods.gdas.goReviewerProfile('eVZUZitnek53RHFHaTVMbFNETDM5dz09')" class="id" data-attr="상품상세^리뷰어프로필^프로필이미지 또는 닉네임 클릭">러브굿</a>
                    <!--## 리뷰 고도화 1차 ## :  탑리뷰어 라운지로 이동시킴 -->
                  </p>
                </div>
              </div>
              <div class="review_cont">
                ...
                <div class="rw-photo-slide" style="display: none">
                  <div>
                    <img src="https://image.oliveyoung.co.kr/uploads/images/gdasEditor/2022/12/27/1672145255473.png">
                  </div>
                </div>
                <!--## 리뷰 고도화 2차 ## 연관상품 -->
                <!--## 리뷰 고도화 1차 ## 위치변경 및 삭제-->
