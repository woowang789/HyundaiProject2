      ...
      <div id="Container">
          ...
          <div class="prd_detail_box renew">
            ...
            <div class="right_area">
              <div class="prd_info">
                  ...
                  <div class="row">
                    <ul class="bl_list">
                      ...
                      <li class="liQuickAI" style="display: none">
                        ...
                        <p class="tx_addre">
                          <span>┖ </span
                          ><span class="quickUsrAddr"
                            >서울특별시 도봉구 도봉로112길</span
                          >
                          기준
                ...
                <div
                  class="prd_option_box optionType1 type2"
                  id="buy_option_box"
                >
                ...
                <div class="prd_total_price">
                  ...
                  <span class="tx_cont"
                    ><span class="tx_num" id="totalPrcTxt">0</span>원</span
                  >
                </div>
                ...
                <div class="today_dv">
                  ...
                  >
                    <input
                      ...
                      name="pickupDirectYn"
                      value="Y"
                      data-attr="상품상세^매장픽업여부^매장픽업신청"
                    /><label for="pickupDirectYn"
                      >매장에서 픽업 하시겠어요?</label
                    >
                    <dl>
                      <dd>
                ...
                <div class="prd_btn_area new-style type1">
                  ...
                  <button
                    ...
                    data-attr="상품상세^주문유형^바로구매"
                  >
                    바로구매
                  </button>

                  <button
                    class="btnSoldout dupItem goods_cart"
                    style="display: none"
                    onclick="javascript:;"
                  >
                    일시품절
          ...
          <ul class="prd_detail_tab" id="tabList">
            <li class="on" id="productInfo">
              <a
                ...
                data-attr="상품상세^상품상세_SortingTab^상품설명"
                >상품설명</a
              >
            </li>
            <li id="buyInfo">
              <a
                href="javascript:;"
                class="goods_buyinfo"
                data-attr="상품상세^상품상세_SortingTab^구매정보"
                >구매정보</a
              >
            </li>
            <li id="reviewInfo">
              <a
                href="javascript:;"
                class="goods_reputation"
                data-attr="상품상세^상품상세_SortingTab^리뷰"
                >리뷰<span>(1,888)</span></a
              >
            </li>
            <li id="qnaInfo"></li>
          </ul>
        ...
        -->
              ...
              <a
                ...
                data-trk="/Cat100000100010008_Small"
                onclick="javascript:common.wlog('mdBanner');"
              >
                <img
              ...
              <div style="text-align: center; padding: 20px 0px 0px 0px">
                <p
                  ...
                  "
                >
                  본 상품 정보(상품 상세, 상품 설명 등)의 내용은 협력사가 직접
                  등록한 것 입니다.
                </p>
              </div>
            </div>
            ...
            <ul
              class="cate_prd_list dispCatBest"
              id="recommGoodsList"
              style="display: none"
            ></ul>
            ...
            <dl class="detail_info_list" id="dlexAjaxInfo">
              ...
              <dd>
                <div>
                  ...
                  <p>
                    올리브영 배송 상품의 총 결제금액 <span>20,000</span>원
                    이상일 경우 <span>무료배송</span> 됩니다.
                  </p>
                  ...
                  <p><strong>배송가능일 : </strong><span>9</span>일</p>
                  <p>
                    배송가능일이란 본 상품을 주문하신 고객님들께 상품 배송이
                    가능한 기간을 의미합니다. 단, 연휴 및 공휴일은 기간 계산시
                    제외하며 현금 주문일 경우 입금일 기준 입니다.
                  </p>
                  <p>
                    예약 상품의 경우 예약된 날짜에 출고되며, 상품의 입고가
                    빠르게 진행된 경우 예약일 보다 일찍 배송될 수 있습니다.
                  </p>
                </div>
                <br />
                <div>
                  ...
                  <p>
                    <strong>배송비 : </strong
                    ><strong>빠름</strong>&nbsp;<span>5,000원</span>,
                    <strong>3!4!/미드나잇</strong>&nbsp;<span>2,500원</span>
                  </p>
                  <p>
                    오늘드림 배송 상품의 총 결제금액&nbsp;<span>30,000</span>원
                    이상일 경우&nbsp;<span>무료배송</span>&nbsp;됩니다.
                  </p>
                  <p>
                    오늘드림 배송비는 도서, 산간지역에 관련없이 배송비가
                    동일합니다.
                  </p>
                  <div class="crlfix">
                    ...
                    <div style="margin-left: 87px">
                      <p>
                        <strong>빠름/미드나잇 </strong>당일 20시까지 주문 시
                        당일 도착, 이후 주문 건 익일 도착
                      </p>
                      <p>
                        <strong>3!4! </strong>당일13시까지 주문 시 당일 도착,
                        이후 주문 건 익일 도착
                      </p>
                    </div>
                  </div>
