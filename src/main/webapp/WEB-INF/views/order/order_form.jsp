...
<div id="Container">
	...
	<div id="Contents">
		...
		<form name="orderForm" id="orderForm">
			<input type="hidden" id="o2oGiftBoxAmtRm" name="o2oGiftBoxAmtRm"
				value="30000"> <input type="hidden" id="o2oGiftBoxAmtDc"
				name="o2oGiftBoxAmtDc" value="2000"> <input type="hidden"
				id="o2oGiftBoxAmtDf" name="o2oGiftBoxAmtDf" value="2000"> <input
				type="hidden" id="o2oGiftBoxAmt" name="o2oGiftBoxAmt" value="0">
			<input type="hidden" id="quickYn" name="quickYn" value="N"> <input
				type="hidden" id="pickupDirectYn" name="pickupDirectYn" value="N">
			<input type="hidden" id="quickInfoYn" name="quickInfoYn" value="N">
			<input type="hidden" id="ocbValidChk" name="ocbValidChk" value="N">

			<input type="hidden" id="o2oVisitTypeVal" name="o2oVisitTypeVal"
				value="">
			...
			<input type="hidden" id="orgIs24HCheckable" name="orgIs24HCheckable"
				value="Y"> <input type="hidden" id="is24HCheckable"
				name="is24HCheckable" value="N"> <input type="hidden"
				id="orgQuickYn" name="orgQuickYn" value="N"> <input
				type="hidden" id="quick24hdisplay" name="quick24hdisplay" value="">
			<input type="hidden" id="default24HHardSet" name="default24HHardSet"
				value="N">
			...
			<table class="tbl_inp_form" style="display: none;">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" id="ordManNm" name="ordManNm"
							value="소규석" class="inpH28" title="주문자명을 입력해주세요." this="주문자명은"
					...
					<tr>
						...
						</select> - <input type="text" id="ordManCellTxnoNo"
							name="ordManCellTxnoNo" value="9559" class="inpH28"
							title="주문자 휴대폰 번호 가운데 자리를 입력해주세요." this="주문자 휴대폰 번호 가운데 자리는"
							style="width: 90px"> - <input type="text"
							id="ordManCellEndNo" name="ordManCellEndNo" value="2602"
							class="inpH28" title="주문자 휴대폰 번호 마지막 4자리를 입력해주세요."
							this="주문자 휴대폰 번호 마지막 자리는" style="width: 90px"></td>
					</tr>
					<tr>
						<th scope="row">이메일</th>
						<td><input type="hidden" id="ordManEmailAddr"
							name="ordManEmailAddr" value="thrbtjr@naver.com"
							title="주문자 이메일 주소를 입력해주세요."> <input type="text"
							id="ordManEmailAddrId" value="thrbtjr" class="inpH28"
							title="주문자 이메일 주소를 입력해주세요." this="주문자 이메일 주소는"
							style="width: 120px"> @ <input type="text"
							id="ordManEmailAddrDmn" value="naver.com" class="inpH28"
							title="이메일도메인을 입력해주세요." this="이메일도메인은" style="width: 120px"
							disabled=""> <select id="ordManEmailAddrDmn_select"
							class="selH28" title="주문자 이메일 주소 도메인을 선택해주세요."
							style="width: 120px">
			...
			<table class="tbl_inp_form important" id="dlvpInfo">
				...
				<tbody>
					...
					<tr>
						...
						<td><span class="chk_area mgzero"><input type="radio"
							...
							<div class="hide_box" id="dlvpSelect_div">
								<!-- 기존 배송지 라디오 선택 시 show 클래스 붙여주세요 -->
								<!--[오늘드림 구매에서 일반배송으로 주문서 들어왔을때 선택한 배송지 셋팅을 위해서 사용 :jwkim]-->
								<input type="hidden" name="selectDlvSeq" value=""> <select
									id="dlvpSelect" name="mbrDlvpSeq" class="selH28"
									title="배송지를 선택해주세요." style="width: 200px"
									data-attr="배송지정보^1_배송지선택" disabled="disabled">
					...
					<tr type="exist" style="display: none;">
						...
						<input type="hidden" id="dlvpNm_exist" name="dlvpNm" value=""
							title="배송지명을 입력해주세요." style="width: 200px" this="배송지명은"
							disabled="disabled">
					</tr>
					...
					<tr id="o2o_dlv_area" style="display: none;">
						...
						<input type="hidden" id="o2oDeliveryScheduleDt"
							name="o2oDeliveryScheduleDt" value="">
						<th scope="row"><label for="inpAddrNm">배송방법</label></th>
						<td class="todayTime">
							<div style="display: none;">
								<input type="radio" id="btn_dlvp_temp1" name="o2oDlvSp"
									value="1"> <input type="radio" id="btn_dlvp_temp3"
									name="o2oDlvSp" value="4"> <input type="radio"
									id="btn_dlvp_temp2" name="o2oDlvSp" value="5"> <input
									type="radio" id="btn_dlvp_temp4" name="o2oDlvSp" value="2">
								<input type="radio" id="btn_dlvp_temp6" name="o2oDlvSp"
									value="6">
							</div>
							<div class="toggleMenu">
								<ul>
									<li class="active"><a href="javascript:void(0);"
										title="오늘드림"><span>오늘드림</span></a></li>
									<li id="pickupToggle" data-attr="배송방법^픽업"><a
										href="javascript:void(0);" title="픽업"><span>픽업</span></a></li>
								</ul>
							</div>
							...
							<p class="charge" id="dlv_dlexPayAmt1" style="display: none;">
								<span id="dlv_dlexPayAmt2"></span><a href="javascript:void(0);"
									onclick="fnLayerSet('todayDlvCostNoti', 'open');"></a>
							</p>
							<ul class="notice">
					...
					<tr id="pickupStoreList" style="display: none;">
						...
						<td class="pickup-area" style="border-top: 2px solid #d6d6d6;">
							<div class="contTopArea">
								<div class="toggleMenu">
									<ul>
										<li id="todayToggle" data-attr="배송방법^오늘드림"><a
											href="javascript:void(0);" title="오늘드림"><span>오늘드림</span></a></li>
										<li class="active"><a href="javascript:void(0);"
											title="픽업"><span>픽업</span></a></li>
									</ul>
								</div>
								<div class="pickupTxt">
									픽업 서비스 안내<a href="javascript:void(0);" title="픽업 서비스 안내"
										onclick="fnLayerSet('aboutPickup', 'open');"></a>
								</div>
							</div> <!-- 지도 컨텐츠 -->
							<div class="pickup-box">
								...
								<div class="pickup-area__left">
									<ul class="pickup-tab" id="pickupTabArea">
										<li class="pickup-tab__list active"
											data-attr="픽업_매장선택^최근 이용 매장">
											<!-- 활성화 클래스 active --> <a href="javascript:;">최근 이용매장</a>
										</li>
										<li class="pickup-tab__list" data-attr="픽업_매장선택^관심 매장"><a
											href="javascript:;">관심매장</a></li>
										<li class="pickup-tab__list" data-attr="픽업_매장선택^그 외 매장">
											<a href="javascript:;">그 외 매장</a>
										</li>
									</ul>
									<p class="pickup-noti" style="display: none;">최근 이용 매장이
										없습니다. 아래 매장을 이용해보세요!</p>
									<div class="pickup-cnt">
										<div class="indif-store" style="display: none;">
											<p class="indif-store__top">
												<span id="pickupMbrNm"></span>님이<br>등록하신 관심매장이 없습니다.
											</p>
											<p class="indif-store__bottom">
												자주 가는 매장을 관심매장으로 등록하면 매장소식을<br>빠르게 받아 보실 수 있습니다.
											</p>
										</div>
										<!-- 매장 검색 박스 -->
										<div class="search-store__top" style="display: none;">
											<div class="search-box">
												<!-- 검색 단어 입력시 포함한 단어가 있을 경우 on 클래스 추가 -->
												<input type="text" class="search-box__inp" name="searchWord"
													onkeyup="javascript:order.pickup.searchPickupStoreList(event);"
													value="" title="매장명/주소 입력 (ex. 명동 또는 퇴계로)"
													placeholder="매장명/주소 입력 (ex. 명동 또는 퇴계로)">
												<div class="search-box__auto"></div>
											</div>
								...
								<!-- // 왼쪽 -->
								<!-- 오른쪽 -->
								<div class="pickup-area__right api_mapArea" id="map"></div>
								<!-- // 오른쪽 -->
							</div>
						</td>
					</tr>
					...
					<tr class="sumtr1" id="pickupHide2" type="exist"
						...
						<td class="imp_data">
						...
						</select> - <input type="text" id="rmitCellTxnoNo_exist"
							...
							<span class="info_security"><button type="button"
									data-rel="layer" data-target="securityInfo" class="chk_area">안심번호
									서비스 안내</button></span>
						</td>
					</tr>
					<tr class="sumtr2" id="pickupHide3" type="exist"
						...
						</select> - <input type="text" id="rmitTelTxnoNo_exist"
							name="rmitTelTxnoNo" value="" class="inpH28"
							title="연락처2 가운데 자리를 입력해주세요." this="연락처2 가운데 자리는"
							style="width: 90px" disabled="disabled"> - <input
							type="text" id="rmitTelEndNo_exist" name="rmitTelEndNo" value=""
							class="inpH28" title="연락처2 마지막 4자리를 입력해주세요." this="연락처2 마지막 자리는"
							style="width: 90px" disabled="disabled"></td>
					</tr>
					...
					<tr type="new" class="new_order_area" style="">
						...
						<td class="imp_data">
							...
							style="width: 500px" this="상세 주소는"> <input type="hidden"
							id="rmitDtlAddr_new" name="rmitDtlAddr" value="" class="inpH28"
							title="상세주소를 입력해주세요." style="width: 500px"> <input
							type="hidden" id="emdNm_new" name="emdNm"> <input
							type="hidden" id="admrNm_new" name="admrNm">
						</td>
					</tr>
				</tbody>
			</table>
			<input type="hidden" id="btn_dlvp_complete_msg_temp1"
				name="o2oMsgSendType" value="Y" checked="">
			<div class="orderConBanner" id="orderConBanner" style="display: none">
				<img
					src="https://image.oliveyoung.co.kr/uploads/images/editor/QuickUpload/SYS/image/20220216232240/qksa_20220216232240.jpg">
				...
				<c:forEach items="${list }" var="orderItem">
					<tr>
						...
						<td colspan="5" dispcatno="" stdcatno="010104"
							...
							ordqty="3"
							thnlpathnm="https://image.oliveyoung.co.kr/uploads/images/goods/10/0000/0017/A00000017577213ko.jpg?l=ko"
							goodsnm="[어워즈 한정] 닥터지 레드 블레미쉬 클리어 수딩크림 70ml_어워즈&nbsp;한정기획(70+50+10)"
							cartno="462961340">
							<!-- 2017-01-13 수정 -->
			...
			<div class="order_payment_box">
				<div class="left_area">
					...
					<ul class="payment_info_form" id="payMethodList">
						<li class="bg_area">
							<!-- 2017-01-18 수정 : 클래스 추가 --> <input type="hidden"
							id="payCouponIndex" value="" paycd=""> <input
							type="hidden" id="easyPayCd" value=""> <span><input
							...
							<table class="tbl_inp_form no_line">
								...
								<tbody>
									<tr>
										...
										<td>
											...
											<div id="cardcoPnt_div">
												...
												<p class="tx_info" acqrcd="DIN" pntusestdamt="5000"
													pntnm="현대카드 M 포인트" salepointflg="S" staffyn="N"
													style="display: none;">
													<span class="mhy_card">현대카드 M포인트 10% 사용 가능(1만원 이상
														결제시 최대 5천 포인트)</span>
												</p>
												<div id="DIN_pntInfoMsg" style="display: none;">
													...
													<ol>
														...
														<li><span style="color: #f27370"><strong>법인/체크/선불/기프트/CJ임직원/CJ제휴카드
																	제외</strong></span></li>
												...
												<p class="tx_info" acqrcd="WIN" pntusestdamt="0" pntnm=""
													salepointflg="S" staffyn="N" style="display: none;">
												...
												<div id="WIN_pntInfoMsg" style="display: none;">
													...
													<ol>
														...
														<li><strong><span style="color: #f27370">법인,
																	체크, 올앳, 선불, 기프트, CJ임직원, CJ제휴카드 제외</span></strong></li>
									...
									<tr id="pntUseYn_tr" style="display: none;">
										...
										<td>
											<div>
												<input type="checkbox" id="pntUseYn" name="pntUseYn"
													value="Y"> <label for="pntUseYn" id="cardcoPntNm"></label>
												<button type="button" class="mh_btn" data-rel="layer"
													data-target="mHPointInfo">사용안내</button>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td colspan="2">
											<div class="info_dot_list_area">
												...
												<ul>
													<li id="cardDscnt_N_li" style="display: none;"><strong>청구할인
															대상이 아닌 상품이 포함되어 있거나 결제금액이 청구할인 대상 금액보다 적어 청구할인 적용이 불가합니다.</strong></li>
													<li id="cardDscnt_Y1_li" style="display: none;">법인/체크/기프트
														카드는 청구할인 대상에서 제외될 수 있습니다.</li>
													<li id="cardDscnt_Y2_li" style="display: none;">일 최대
														청구할인 한도에 따라 청구할인 예상금액은 달라질 수 있습니다.</li>
							...
							<table class="tbl_inp_form no_line">
								...
								<tbody>
									<tr>
										...
										<td>
											<div>
												<select id="VirDepositBank" name="cjBnkCd" class="selH28"
													title="은행를 선택해주세요." style="width: 300px"
													data-attr="결제수단선택^은행명" disabled="disabled">
												...
												</select> <select name="bnkCd" style="display: none;"
													disabled="disabled">
								...
								<tr>
								 ...
								 -->
									<tr>
										...
										<td>
											<div>
												<input type="text" id="NameDepositor" name="morcManNm"
													value="소규석" class="inpH28" title="입금자명을 입력해주세요."
													style="width: 200px" data-attr="결제수단선택^입금자명"
													disabled="disabled">
											</div>
										</td>
									</tr>
									...
									<tr>
										<td colspan="2">
											<div class="info_dot_list_area">
												...
												<ul>
													<li><span style="color: #757d86">은행별로 입금가능시간이
															다를 수 있습니다.</span></li>
												</ul>
						...
						<li paymethod="23" style="display: none;">
							<div class="other_cash_box">
								...
								<div class="cash_inquiry_area" id="cultureLandBeforeLogin">
									...
									<button class="btnSmall wGray2" type="button" data-rel="layer"
										data-target="cultureLandLoginPop" id="cultureLandLoginPop_btn">조회</button>
								</div>
								<!--// 조회 전 -->
								<!-- 조회 후 -->
								<div class="cash_inquiry_area" id="cultureLandAfterLogin"
									style="display: none;">
									<input type="hidden" id="cultureLandOwnCash" value=""
										disabled="disabled">
									<p>
										고객님의 보유하신 컬쳐캐쉬는 <span class="cash_price"><span
											class="tx_num" id="cultureLandOwnCash_span"></span>원</span>입니다.
									</p>
									<p class="tx_info">최종 결제금액을 확인하신 후, [결제하기] 버튼을 클릭하시면 결제가
										완료됩니다.</p>
									<button class="btnSmall wGray2" type="button"
										id="cultureLandInquire_btn">다시 조회</button>
								</div>
								<!--// 조회 후 -->
								<div class="info_dot_list_area">
						...
						<li paymethod="24" style="display: none;">
							<div class="other_cash_box">
								...
								<div class="cash_inquiry_area" id="bookAndLifeBeforeLogin">
									...
									<button class="btnSmall wGray2" type="button" data-rel="layer"
										data-target="bookAndLifeLoginPop" id="bookAndLifeLoginPop_btn">조회</button>
								</div>
								<!--// 조회 전 -->
								<!-- 조회 후 -->
								<div class="cash_inquiry_area" id="bookAndLifeAfterLogin"
									style="display: none;">
									<input type="hidden" id="bookAndLifeOwnCash" value=""
										disabled="disabled">
									<p>
										고객님의 보유하신 북앤라이프 캐쉬는 <span class="cash_price"><span
											class="tx_num" id="bookAndLifeOwnCash_span"></span>원</span>입니다.
									</p>
									<p class="tx_info">최종 결제금액을 확인하신 후, [결제하기] 버튼을 클릭하시면 결제가
										완료됩니다.</p>
									<button class="btnSmall wGray2" type="button"
										id="bookAndLifeInquire_btn">다시 조회</button>
								</div>
								<!--// 조회 후 -->
								<div class="info_dot_list_area">
						...
						<li paymethod="25" style="display: none;">
							<div class="other_cash_box">
								<div class="info_dot_list_area">
									...
									&nbsp;
									<ul>
										<li><strong><span style="color: #757d86"><payco
														 포인트 리워드=""></payco 포인트></span></strong></li>
										<li><strong><span style="color: #757d86">페이코&nbsp;충전포인트로
													결제 시 마다,&nbsp;5% 적립!</span></strong></li>
										<li><strong><span style="color: #757d86">생애
													첫가입 시 3,000P + 생애 첫 결제시 1,000P 적립!</span></strong></li>
										<li><span style="color: #757d86">자세한 내용은 이벤트탭 내
												결제혜택 페이지에서 확인 가능합니다.</span></li>
									</ul>
									...
									<ul>
										<li>PAYCO는 NHN엔터테인먼트에서 제공하는 안전한 간편결제 서비스로 올리브영몰에서는 신용카드
											결제가 가능합니다.</li>
							...
							<div class="other_kakao_box">
								<div class="info_dot_list_area">
									...
									<ul>
										...
										<li><span style="color: #757d86"><span
												style="font-family: 맑은 고딕">무이자할부는 카카오페이 모바일 결제창에서
													선택하실 수 있습니다.</span></span></li>
										<li><span style="color: #757d86"><span
												style="font-family: 맑은 고딕">휴대폰과 카드명의자가 동일해야 결제 가능합니다.</span></span></li>
										<li><span style="color: #757d86"><span
												style="font-family: 맑은 고딕">카카오페이 결제 시, 제휴카드
													할인/적립(CJ카드, CJ iD카드, 임직원할인 포함)이 적용되지 않습니다.</span></span></li>
										<li><span style="color: #757d86"><span
												style="font-family: 맑은 고딕">카드 영수증 및 현금영수증
													확인은&nbsp;카카오페이 홈페이지에서 확인 가능합니다.(카카오페이 홈 &gt; 설정 &gt; 결제내역)</span></span></li>
										<li><span style="color: #757d86"><span
												style="font-family: 맑은 고딕">카카오페이 고객센터 : 1644-7405</span></span></li>
									</ul>
						...
						<li paymethod="29" style="display: none;">
							<div class="other_kakao_box">
								<div class="info_dot_list_area">
									...
									<ul>
										<li><span style="font-size: 12px"><span
												style="color: #757d86"><strong>&lt;네이버페이
														첫결제혜택&gt;</strong></span></span></li>
										<li><span style="font-size: 12px"><span
												style="color: #757d86"><strong>① 3만원↑결제
														시&nbsp;<u>최대 6,000&nbsp;NPAY&nbsp;포인트 지급</u>
												</strong></span></span><br> <span style="font-size: 12px"><span
												style="color: #757d86">▶ 22년 결제 경험이 없는 대상 3천P + 개인
													하나(신용/체크)카드 결제 시 3천P (깍 이용도 가능)</span></span></li>
										<li><span style="font-size: 12px"><span
												style="color: #757d86"><strong>② 네이버페이 결제
														유형에 따라 최대 2.5% 상시 지급</strong></span></span></li>
										<li><span style="font-size: 12px"><span
												style="color: #757d86">※ 자세한 내용은 이벤트 탭 결제혜택에서 확인
													가능합니다</span></span></li>
									</ul>
									...
									<ul>
										<li><span style="color: #757d86"><strong>&lt;네이버페이
													유의사항&gt;</strong></span></li>
										<li><span style="color: #757d86">주문 변경 시 카드사 혜택 및
												할부 적용 여부는 해당 카드사 정책에 따라 변경될 수 있습니다.</span></li>
										<li><span style="color: #757d86">네이버페이로 결제 시, 제휴카드
												할인/적립(CJ카드, CJ iD카드, 임직원할인 포함)이 적용되지 않습니다.</span></li>
										<li><span style="color: #757d86">현금영수증 확인은 네이버페이
												홈페이지에서 확인 가능합니다. (네이버페이 홈 &gt; 결제내역)</span></li>
										<li><span style="color: #757d86">네이버페이 고객센터 :
												1588-3819</span></li>
									</ul>
									...
									<td>
										<div>
											<select id="crIssuCd" name="crIssuCd" class="selH28"
												...
												data-attr="현금영수증신청^현금영수증" disabled="">
									...
									<td>
										<div>
											<input type="radio" id="crIssuMeanSctCd_3"
												...
												data-attr="현금영수증신청^발급방법" disabled=""> <label
												for="crIssuMeanSctCd_3">휴대폰</label> <input type="radio"
												id="crIssuMeanSctCd_5" name="crIssuMeanSctCd" value="5"
												data-attr="현금영수증신청^발급방법" disabled=""> <label
												for="crIssuMeanSctCd_5">현금영수증카드</label>
										</div>
									</td>
								</tr>
								<!-- 개인소득공제용 [휴대폰] 선택 시 -->
									...
									<td>
										<div>
											<select id="dispCashReceiptInfo11" class="selH28"
												...
												data-attr="현금영수증신청^휴대폰" disabled="">
											...
											</select> - <input type="text" id="dispCashReceiptInfo12" value="9559"
												class="inpH28" title="현금영수증 휴대폰 가운데 자리를 입력해주세요."
												this="현금영수증 휴대폰 가운데 자리는" style="width: 90px"
												data-attr="현금영수증신청^휴대폰" disabled=""> - <input
												type="text" id="dispCashReceiptInfo13" value="2602"
												class="inpH28" title="현금영수증 휴대폰 마지막 4자리수를 입력해주세요."
												this="현금영수증 휴대폰 마지막 자리는" style="width: 90px"
												data-attr="현금영수증신청^휴대폰" disabled=""> <input
												type="hidden" id="crPhoneNumber" name="crIssuMeanNo"
												value="01095592602" disabled="">
										</div>
									</td>
								</tr>
								<!--//개인소득공제용 [휴대폰] 선택 시 -->
									...
									<td>
										<div>
											<input type="text" id="CashReceipts" name="crIssuMeanNo"
												class="inpH28" title="현금영수증 카드번호를 입력해주세요."
												this="현금영수증 카드번호는" style="width: 300px" disabled="">
										</div>
									</td>
								</tr>
								<!--// 개인소득공제용 [현금영수증카드] 선택 시 -->
									...
									<td>
										<div>
											<input type="hidden" name="crIssuMeanSctCd" value="2"
												disabled=""> <input type="text" id="BusinessNumber"
												name="crIssuMeanNo" class="inpH28"
												title="현금영수증 사업자 등록번호를 입력해주세요." this="현금영수증 사업자 등록번호는"
				...
				<div class="right_area">
					...
					<ul class="total_payment_box">
						...
						<li id="oyGiftCardAplyAmt_li" style="display: none;"><span
							class="tx_tit">올리브영 기프트카드</span> <span
							class="tx_cont colorOrange"><span class="tx_num"
								id="oyGiftCardAplyAmt_span">0</span>원</span></li>
						<li id="cjGiftCardAplyAmt_li" style="display: none;"><span
							class="tx_tit">CJ 기프트카드</span> <span class="tx_cont colorOrange"><span
								class="tx_num" id="cjGiftCardAplyAmt_span">0</span>원</span></li>

						<!-- 임직원일 경우 -->
						<li id="cafeteriaPntAplyAmt_li" style="display: none;"><span
							class="tx_tit">카페테리아 포인트</span> <span class="tx_cont colorOrange"><span
								class="tx_num c" id="cafeteriaPntAplyAmt_span">0</span>원</span></li>
						<!--// 임직원일 경우 -->
						<li id="csmnAplyAmt_li" style="display: none;"><span
							class="tx_tit">예치금</span> <span class="tx_cont colorOrange"><span
								class="tx_num" id="csmnAplyAmt_span">0</span>원</span></li>
						<li id="culturelandGiftAplyAmt_li" style="display: none;"><span
							class="tx_tit">컬쳐캐쉬</span> <span class="tx_cont colorOrange"><span
								class="tx_num" id="culturelandGiftAplyAmt_span">0</span>원</span></li>
						<li id="bookGiftAplyAmt_li" style="display: none;"><span
							class="tx_tit">북앤라이프캐쉬</span> <span class="tx_cont colorOrange"><span
								class="tx_num" id="bookGiftAplyAmt_span">0</span>원</span></li>
						...
						<li>
							...
							<button class="btnPayment" id="btnPay" name="btnPay"
								type="button" onclick="location.href='/order-completion'"
								data-attr="최종결제정보^결제하기">
								결제하기<em id="giftNoti3" style="display: none;">(증정품은 결제 시 확인
									가능합니다)</em> <em id="giftNotiQuick" style="display: none;">(오늘드림으로
									주문 시 온라인 단독 <br>증정품이 제공되지 않습니다.)
								</em> <em id="giftNoti4" style="display: none;">(오늘드림 주문은 온라인 전용
									증정품이<br>제공되지 않습니다.)
								</em>
							</button> <input type="hidden" id="tempOrdNo" value="">
						</li>
					</ul>
