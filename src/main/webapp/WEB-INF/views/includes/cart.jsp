...
<div id="Container">
	...
	<form name="cartForm" id="cartForm">
		<input type="hidden" id="btnOrderTp" name="btnOrderTp" value="" /> <input
			type="hidden" id="cartNo" name="cartNo" value="" /> <input
			type="hidden" id="partYn" name="partYn" value="" /> <input
			type="hidden" id="optChgYn" name="optChgYn" value="Y" /> <input
			type="hidden" id="quickYn" name="quickYn" value="N" /> <input
			type="hidden" id="quickOrdPsbMaxQty" name="quickOrdPsbMaxQty"
			value="999" /> <input type="hidden" id="quickOrdTimeFrom"
			name="quickOrdTimeFrom" value="0" /> <input type="hidden"
			id="quickOrdTimeTo" name="quickOrdTimeTo" value="24" /> <input
			type="hidden" id="o2oBlockInfo" name="o2oBlockInfo"
			value='{"o2oBlockMsg":"시스템점검으로 오늘드림 서비스에 제한이 있습니다.\n빠른 시간안에 서비스 재개 하도록 하겠습니다.","o2oBlockYn":"N"}' />

		<input type="hidden" id="ktmDestYn" name="ktmDestYn" value="Y" /> <input
			type="hidden" id="oldAddrYn" name="oldAddrYn" value="Y" />
		<!-- 구주소 유효성 여부 -->
		...
		<div id="Contents">
			...
			<table class="tbl_prd_list tableFix">
				...
				<tbody>
					...
					<tr soldoutyn="N" cno="462961340" goodsno="A000000175772"
						itemno="001" lgcgoodsno="8809838656159" oripno="" pno=""
						promkndcd="" rsvsaleyn="N" drtpuryn="N" dispcatno=""
						buycondstrtqtyamt="" getcondstrtqtyamt="" pkggoodsno=""
						quickyn="N" strno="" onladltcertyn=""
						criteo-goods="A000000175772001" trackingcd="Best_Sellingbest"
						gatecd="Main">
						...
						<td colspan="7">
							<div class="tbl_cont_area">
								...
								<input type="hidden" id="saleCpnDcPrc" name="saleCpnDcPrc"
									value="22680" /> <input type="hidden" id="goodsCpnYn"
								...
								<div class="tbl_cell w40">
									<input type="checkbox" saleprc="25200" orgsaleprc="38000"
										cpndcamt="2520" ordqty="3" rsvstockqty="N" stockqty="3848"
										checked="checked" id="inp_prd_chk1" name="s_checkbox1"
										soldoutyn="N" value="0" class="chkSmall"
										title="[[어워즈 한정] 닥터지 레드 블레미쉬 클리어 수딩크림 70ml_어워즈&nbsp;한정기획(70+50+10)] 선택" />

									<input type="hidden" name="s_cart_no" value="462961340" /> <input
										type="hidden" name="s_prom_no" value="" /> <input
										type="hidden" name="s_buy_cond_strt_qty_amt" value="" /> <input
										type="hidden" name="s_disp_cat_no" value="" /> <input
										type="hidden" name="s_goods_no" value="A000000175772" /> <input
										type="hidden" name="s_item_no" value="001" /> <input
										type="hidden" name="s_cpn_dc_amt" value="2520" /> <input
										type="hidden" name="s_org_sale_prc" value="38000" /> <input
										type="hidden" name="s_sale_prc" value="25200" /> <input
										...
										type="hidden" name="s_entr_no" value="C14409" /> <input
								...
								<div class="tbl_cell w390">
									<div class="prd_info">
										<a class="prd_img"
											href="javascript:common.link.moveGoodsDetail('A000000175772','');">
											<img
											data-original="https://image.oliveyoung.co.kr/uploads/images/goods/220/10/0000/0017/A00000017577213ko.jpg?l=ko"
                      ...
                      -->
										...
										<a class="prd_name"
											href="javascript:common.link.moveGoodsDetail('A000000175772','');">
											<span class="tx_sale_info"> </span> <!-- 브랜드명 및 할인정보 --> <span
											id="brandNm">닥터지 </span>
											<p id="goodsNm">[어워즈 한정] 닥터지 레드 블레미쉬 클리어 수딩크림
												70ml_어워즈&nbsp;한정기획(70+50+10)</p>
										</a>
										<p class="prd_opt"></p>
										<p class="prd_flag">
								...
								<div class="tbl_cell w100">
									<div class="prd_cnt">
										<select class="amount" name="s_amount" prdtp="1" prdcnt="0"
											ordpsbminqty="1" ordpsbmaxqty="999" qtyaddunit="1" ordqty="3"
											title="상품 수량 선택">
								...
								<div class="tbl_cell w110">
									<span class="org_price"> <span class="tx_num">114,000</span>원
									</span> <span class="pur_price"><span class="tx_num">68,040</span>원</span>
								</div>
                      ...
                      <input type="text" name="test9" value = "1" /> -->
							...
							<div class="curation_box"
								id="curation_area_8809838656159_A000000175772_001">
					...
					<tr soldoutyn="N" cno="462961288" goodsno="A000000175617"
						itemno="001" lgcgoodsno="8806011437895" oripno="" pno=""
						promkndcd="" rsvsaleyn="N" drtpuryn="N" dispcatno=""
						buycondstrtqtyamt="" getcondstrtqtyamt="" pkggoodsno=""
						quickyn="N" strno="" onladltcertyn=""
						criteo-goods="A000000175617001" trackingcd="Best_Sellingbest"
						gatecd="Main">
						<input type="hidden" id="soldout_yn" name="soldout_yn" value="N" />
						...
						<td colspan="7">
							<div class="tbl_cont_area">
								...
								<input type="hidden" id="saleCpnDcPrc" name="saleCpnDcPrc"
									value="0" /> <input type="hidden" id="goodsCpnYn"
									name="goodsCpnYn" value="N" />
								<script type="text/javascript">
									cartItem = {};
								...
								<div class="tbl_cell w40">
									<input type="checkbox" saleprc="61500" orgsaleprc="75000"
										cpndcamt="0" ordqty="1" rsvstockqty="N" stockqty="6649"
										checked="checked" id="inp_prd_chk1" name="s_checkbox1"
										soldoutyn="N" value="1" class="chkSmall"
										title="[[어워즈한정]오쏘몰&nbsp;이뮨&nbsp;멀티비타민&amp;미네랄&nbsp;14+1입 추가증정(위클리 플래너 증정)] 선택" />

									<input type="hidden" name="s_cart_no" value="462961288" /> <input
										type="hidden" name="s_prom_no" value="" /> <input
										type="hidden" name="s_buy_cond_strt_qty_amt" value="" /> <input
										type="hidden" name="s_disp_cat_no" value="" /> <input
										type="hidden" name="s_goods_no" value="A000000175617" /> <input
										type="hidden" name="s_item_no" value="001" /> <input
										type="hidden" name="s_cpn_dc_amt" value="0" /> <input
										type="hidden" name="s_org_sale_prc" value="75000" /> <input
										type="hidden" name="s_sale_prc" value="61500" /> <input
										type="hidden" name="s_drt_pur_yn" value="N" /> <input
										type="hidden" name="s_dlex_polc_no" value="1" /> <input
										type="hidden" name="s_trade_shp_cd" value="1" /> <input
										type="hidden" name="s_entr_no" value="C14978" /> <input
										type="hidden" name="s_sum_pkg_yn" value="Y" /> <input
										type="hidden" name="s_whsg_expc_dt" value="" /> <input
										type="hidden" name="s_dlex_free_yn" value="N" />
								</div>
								<div class="tbl_cell w390">
									<div class="prd_info">
										<a class="prd_img"
											href="javascript:common.link.moveGoodsDetail('A000000175617','');">
											<img
											data-original="https://image.oliveyoung.co.kr/uploads/images/goods/220/10/0000/0017/A00000017561702ko.jpg?l=ko"
											class="completed-seq-lazyload" alt="상품이미지"
											onerror="common.errorImg(this);"
                      ...
                      -->
										...
										<a class="prd_name"
											...
											id="brandNm">오쏘몰 </span>
											<p id="goodsNm">
												[어워즈한정]오쏘몰&nbsp;이뮨&nbsp;멀티비타민&amp;미네랄&nbsp;14+1입 추가증정(위클리
												플래너 증정)</p>
										</a>
										<p class="prd_opt"></p>
										<p class="prd_flag">
								...
								<div class="tbl_cell w100">
									<div class="prd_cnt">
										<select class="amount" name="s_amount" prdtp="1" prdcnt="1"
											ordpsbminqty="1" ordpsbmaxqty="5" qtyaddunit="1" ordqty="1"
											title="상품 수량 선택">
								...
								<div class="tbl_cell w110">
									<span class="org_price"> <span class="tx_num">75,000</span>원
									</span> <span class="pur_price"><span class="tx_num">61,500</span>원</span>
								</div>
                      ...
                      <input type="text" name="test9" value = "1" /> -->
							...
							<div class="curation_box"
								id="curation_area_8806011437895_A000000175617_001">
								<div class="loading_box">
									<span class="icon"><img
										src="https://static.oliveyoung.co.kr/pc-static-root/image/comm/pc_loading.gif"
										alt="로딩중" /></span>
					...
					<tr soldoutyn="N" cno="462762497" goodsno="A000000144535"
						itemno="001" lgcgoodsno="8809685771937" oripno="" pno=""
						promkndcd="" rsvsaleyn="N" drtpuryn="N" dispcatno=""
						buycondstrtqtyamt="" getcondstrtqtyamt="" pkggoodsno=""
						quickyn="N" strno="" onladltcertyn=""
						criteo-goods="A000000144535001"
						trackingcd="Cat100000100010008_Small" gatecd="PDP">
						<input type="hidden" id="soldout_yn" name="soldout_yn" value="N" />
						...
						<td colspan="7">
							<div class="tbl_cont_area">
								...
								<div class="tbl_cell w40">
									<input type="checkbox" saleprc="32000" orgsaleprc="32000"
										cpndcamt="0" ordqty="1" rsvstockqty="N" stockqty="199"
										checked="checked" id="inp_prd_chk1" name="s_checkbox1"
										soldoutyn="N" value="2" class="chkSmall"
										title="[브로앤팁스 네버오일리 올인원 120ML 기획(+바디워시100ML)] 선택" /> <input
										type="hidden" name="s_cart_no" value="462762497" /> <input
										type="hidden" name="s_prom_no" value="" /> <input
										type="hidden" name="s_buy_cond_strt_qty_amt" value="" /> <input
										type="hidden" name="s_disp_cat_no" value="" /> <input
										type="hidden" name="s_goods_no" value="A000000144535" /> <input
										type="hidden" name="s_item_no" value="001" /> <input
										type="hidden" name="s_cpn_dc_amt" value="0" /> <input
										type="hidden" name="s_org_sale_prc" value="32000" /> <input
										type="hidden" name="s_sale_prc" value="32000" /> <input
										type="hidden" name="s_drt_pur_yn" value="N" /> <input
										type="hidden" name="s_dlex_polc_no" value="1" /> <input
										type="hidden" name="s_trade_shp_cd" value="1" /> <input
										type="hidden" name="s_entr_no" value="C15399" /> <input
										type="hidden" name="s_sum_pkg_yn" value="Y" /> <input
										type="hidden" name="s_whsg_expc_dt" value="" /> <input
										type="hidden" name="s_dlex_free_yn" value="N" />
								</div>
								<div class="tbl_cell w390">
									<div class="prd_info">
										<a class="prd_img"
											href="javascript:common.link.moveGoodsDetail('A000000144535','');">
											<img
											data-original="https://image.oliveyoung.co.kr/uploads/images/goods/220/10/0000/0014/A00000014453508ko.jpg?l=ko"
											class="completed-seq-lazyload" alt="상품이미지"
											onerror="common.errorImg(this);"
                      ...
                      -->
										...
										<a class="prd_name"
											href="javascript:common.link.moveGoodsDetail('A000000144535','');">
											<span class="tx_sale_info"> </span> <!-- 브랜드명 및 할인정보 --> <span
											id="brandNm">브로앤팁스 </span>
											<p id="goodsNm">브로앤팁스 네버오일리 올인원 120ML 기획(+바디워시100ML)</p>
										</a>
										<p class="prd_opt">
											<i class="tit">옵션</i><span>네버오일리 기획</span>

											<button type="button" class="change"
												data-ref-goodsno="A000000144535" data-ref-itemno="001">
												옵션변경</button>
										</p>
										<p class="prd_flag">
								...
								<div class="tbl_cell w100">
									<div class="prd_cnt">
										<select class="amount" name="s_amount" prdtp="1" prdcnt="2"
								...
								<div class="tbl_cell w110">
									<span class="org_price"> </span> <span class="pur_price"><span
										class="tx_num">32,000</span>원</span>
								</div>
                      ...
                      <input type="text" name="test9" value = "1" /> -->
							...
							<div class="curation_box"
								id="curation_area_8809685771937_A000000144535_001">
								<div class="loading_box">
									<span class="icon"><img
										src="https://static.oliveyoung.co.kr/pc-static-root/image/comm/pc_loading.gif"
										alt="로딩중" /></span>
			...
			<div class="basket_price_info">
				...
				<div class="sum_price">
					총 판매가 <span class="tx_num">221,000</span>원 <span
						class="tx_sign minus">-</span> 총 할인금액 <span class="tx_num">59,460</span>원
					...
					<span class="span_quickDeliCharge" style="display: none">(3!4!,
						...
						class="tx_total_price">총 결제금액 <span class="tx_price"><span
							class="tx_num">161,540</span>원</span></span>
				</div>
			</div>
			<!--// 올리브영 배송상품 결제금액 -->
       ...
       -->
			...
			<div class="total_price_info">
				<div class="detail_price">
					<p>
						총 판매가<span><span class="tx_num">221,000</span>원</span>
					</p>
					<span class="tx_sign2 minus">-</span>
					<p class="tx_sale">
						총 할인금액<span><span class="tx_num">59,460</span>원</span>
					</p>
				...
				<div class="sum_price">
					<span class="tx_text">배송비는 쿠폰할인금액에 따라 변경될 수 있습니다.</span> 총 결제예상금액 <span
						...
						class="tx_price"><span class="tx_num">161,540</span>원</span>
				</div>
			</div>

			<div class="order_btn_area order_cart">
				<button type="button" class="btnOrange" onclick="location.href='/order-completion'" name="allOrderBtn"
