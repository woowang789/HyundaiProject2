	...
	<div class="twoConts">
		<div class="conts">
			<ul class="list-area">
				<li>
					<p class="logo s_yearend">
						<a href="javascript:common.link.moveMainHome();"> <img
							src="https://static.oliveyoung.co.kr/pc-static-root/image/footer/foot_logo_yearend.png"
							alt="OLIVEYOUNG" />
						</a>
					</p>
					<h2>씨제이올리브영 주식회사</h2>
				...
				<li>
					<ul class="list-link">
						<li><a href="javascript:common.link.moveTermsPage();">이용약관</a>
							<a href="javascript:common.link.moveLegalPage();">법적고지</a></li>
						<li><a href="javascript:common.link.movePrivacyPage();">개인정보처리방침</a>
						</li>
						<li><a
							href="javascript:common.link.moveYouthProtectionPage();">청소년보호방침</a>
						</li>
						<li><a href="javascript:common.link.moveMultimediaPage();">영상정보처리기기
								운영/관리 방침</a></li>
						<li><a href="javascript:common.link.moveDenyEmailPage();">이메일무단수집거부</a>
						</li>
					</ul>
				</li>
				<li>
					<h2>하나은행 구매안전 서비스</h2>
					<p>
						올리브영은 현금 결제한 금액에 대해<br /> 하나은행과 채무지급보증 계약을체결<br /> 하여 안전한 거래를
						보장하고 있습니다<br /> <a class="link" title="새창 열림">서비스 가입사실 확인</a>
					</p>
				</li>
			</ul>
		</div>
